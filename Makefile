#############################################################################
# Makefile for building: PackageTracker.app/Contents/MacOS/PackageTracker
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  package-tracker.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile package-tracker.pro -spec macx-clang
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PackageTracker1.0.0
DISTDIR = /Users/mitchellmoss/projects/package-tracker/.tmp/PackageTracker1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -L/opt/homebrew/opt/qt/lib -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtNetwork -framework QtCore -framework IOKit -framework DiskArbitration -framework AGL -framework OpenGL   
...
EXPORT__QMAKE_STASH_ = /Users/mitchellmoss/projects/package-tracker/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/mitchellmoss/projects/package-tracker/package-tracker.pro
...
PackageTracker.app/Contents/MacOS/PackageTracker:  $(OBJECTS)  
	@test -d PackageTracker.app/Contents/MacOS/ || mkdir -p PackageTracker.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: package-tracker.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile package-tracker.pro -spec macx-clang
...
PackageTracker.app/Contents/PkgInfo: 
	@test -d PackageTracker.app/Contents || mkdir -p PackageTracker.app/Contents
	@$(DEL_FILE) PackageTracker.app/Contents/PkgInfo
	@echo "APPL????" > PackageTracker.app/Contents/PkgInfo
PackageTracker.app/Contents/Info.plist: 
	@test -d PackageTracker.app/Contents || mkdir -p PackageTracker.app/Contents
	@$(DEL_FILE) PackageTracker.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,LM.PackageTracker,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},LM.PackageTracker,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,PackageTracker,g" -e "s,@LIBRARY@,PackageTracker,g" -e "s,\$${EXECUTABLE_NAME},PackageTracker,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >PackageTracker.app/Contents/Info.plist

all: Makefile \
		PackageTracker.app/Contents/PkgInfo \
		PackageTracker.app/Contents/Info.plist PackageTracker.app/Contents/MacOS/PackageTracker
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h fedexclient.h upsclient.h settingsdialog.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp fedexclient.cpp upsclient.cpp settingsdialog.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_fedexclient.cpp moc_upsclient.cpp moc_settingsdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_fedexclient.cpp moc_upsclient.cpp moc_settingsdialog.cpp
...
moc_fedexclient.cpp: fedexclient.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/opt/qt/include/QtCore/qobjectdefs.h \
		/opt/homebrew/opt/qt/include/QtCore/qnamespace.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/mitchellmoss/projects/package-tracker/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/mitchellmoss/projects/package-tracker -I/opt/homebrew/opt/qt/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib fedexclient.h -o moc_fedexclient.cpp

moc_upsclient.cpp: upsclient.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/opt/qt/include/QtCore/qobjectdefs.h \
		/opt/homebrew/opt/qt/include/QtCore/qnamespace.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/mitchellmoss/projects/package-tracker/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/mitchellmoss/projects/package-tracker -I/opt/homebrew/opt/qt/include -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib upsclient.h -o moc_upsclient.cpp
...
fedexclient.o: fedexclient.cpp fedexclient.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/opt/qt/include/QtCore/qobjectdefs.h \
		/opt/homebrew/opt/qt/include/QtCore/qnamespace.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/qtimer.h \
		/opt/homebrew/opt/qt/include/QtCore/qbasictimer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fedexclient.o fedexclient.cpp

upsclient.o: upsclient.cpp upsclient.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/opt/qt/include/QtCore/qobjectdefs.h \
		/opt/homebrew/opt/qt/include/QtCore/qnamespace.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o upsclient.o upsclient.cpp
...
moc_fedexclient.o: moc_fedexclient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_fedexclient.o moc_fedexclient.cpp

moc_upsclient.o: moc_upsclient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_upsclient.o moc_upsclient.cpp
