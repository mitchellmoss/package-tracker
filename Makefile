...
DEFINES       = -DSHIPPO_API_BASE_URL=\"https://api.goshippo.com\" -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
PackageTracker.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,LM.PackageTracker,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},LM.PackageTracker,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,app.icns,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},app.icns,g" -e "s,@EXECUTABLE@,PackageTracker,g" -e "s,@LIBRARY@,PackageTracker,g" -e "s,\$${EXECUTABLE_NAME},PackageTracker,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >PackageTracker.app/Contents/Info.plist
PackageTracker.app/Contents/Resources/app.icns: icons/app.icns
	@test -d PackageTracker.app/Contents/Resources/ || mkdir -p PackageTracker.app/Contents/Resources/
	@$(DEL_FILE) PackageTracker.app/Contents/Resources/app.icns
	@$(COPY_FILE) icons/app.icns PackageTracker.app/Contents/Resources/app.icns

all: Makefile \
		PackageTracker.app/Contents/PkgInfo \
		PackageTracker.app/Contents/Info.plist \
		PackageTracker.app/Contents/Resources/app.icns PackageTracker.app/Contents/MacOS/PackageTracker
...
moc_mainwindow.cpp: mainwindow.h \
		...
		/opt/homebrew/opt/qt/lib/QtWidgets.framework/Headers/QGraphicsEffect \
...
moc_shippoclient.cpp: shippoclient.h \
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/qobject.h \
		/opt/homebrew/lib/QtNetwork.framework/Headers/QNetworkAccessManager \
		/opt/homebrew/lib/QtNetwork.framework/Headers/qnetworkaccessmanager.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/mitchellmoss/projects/package-tracker/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/mitchellmoss/projects/package-tracker -I/opt/homebrew/opt/qt/lib/QtCore.framework/Headers -I/opt/homebrew/opt/qt/lib/QtGui.framework/Headers -I/opt/homebrew/opt/qt/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/16/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.2.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib shippoclient.h -o moc_shippoclient.cpp
...
main.o: main.cpp /opt/homebrew/opt/qt/lib/QtWidgets.framework/Headers/QApplication \
		/opt/homebrew/opt/qt/lib/QtWidgets.framework/Headers/qapplication.h \
		mainwindow.h \
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/QCoreApplication \
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/qcoreapplication.h \
...
mainwindow.o: mainwindow.cpp mainwindow.h \
		...
		/opt/homebrew/opt/qt/lib/QtWidgets.framework/Headers/QGraphicsBlurEffect \
...
shippoclient.o: shippoclient.cpp shippoclient.h \
		...
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/QDateTime \
		/opt/homebrew/opt/qt/lib/QtCore.framework/Headers/qdatetime.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o shippoclient.o shippoclient.cpp
...
moc_shippoclient.o: moc_shippoclient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_shippoclient.o moc_shippoclient.cpp
